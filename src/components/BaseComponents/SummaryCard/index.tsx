...
function SummaryCard(props: SummaryCardProps) {
  ...
  if (isLoading) {
    return (
      <div className="w-full h-full items-center flex flex-row bg-gray2Background px-5 py-6 rounded-lg animate-pulse">
  ...
  return (
    <div className="w-full h-full items-center flex flex-row bg-gray2Background hover:bg-darkGray1Background px-5 py-6 rounded-lg group transition-colors text-nowrap">
