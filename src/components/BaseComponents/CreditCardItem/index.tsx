    ...
    return (
        <div
            className={clsx(
                ...
                isFirst ? "w-full z-0 top-0 h-55" : "w-[90%] left-[5%] z-10 top-35 h-55 shadow-2xl backdrop-blur-md"
            )}
        >
            {!isFirst && (
                ...
                >
                    <div
                        className={clsx(
                            ...
                            isFirst ? "text-2xl" : "text-[22px] mb-2 text-text1Color"
                        )}
                    >
                        {card.cardNumber}
                    </div>
                    ...
                    {!isFirst && (
                        <div className="flex items-end justify-between w-full">
                            <div className="text-xs font-light opacity-80 text-text1Color">
